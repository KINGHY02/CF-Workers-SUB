...
async function nginx() {
	...
	<a href="http://kingzy.us.kg/">国王云</a>.<br/>
	Commercial support is available at
	<a href="https://qm.qq.com/q/HPUZWGzOqy">客服QQ</a>.</p>
...
<head>
    ...
    <script>
        // 动态生成广告页面的内容
        function openAdPage() {
            const adWindow = window.open("", "_blank", "width=500,height=500");
...
<body>
    <button onclick="openAdPage()">点击查看广告</button>
</body>
</html>
